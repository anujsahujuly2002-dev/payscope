...
var BarchartGrowthColors = getChartColorsArray("growth-chart1");
...
if (BarchartGrowthColors) {
  ...
  var chart2 = new ApexCharts(document.querySelector("#growth-chart1"), options2);
  chart2.render();
} //
var BarchartGrowthColors = getChartColorsArray("growth-chart2");
...
if (BarchartGrowthColors) {
  ...
  var chart2 = new ApexCharts(document.querySelector("#growth-chart2"), options2);
  chart2.render();
} //

var BarchartGrowthColors = getChartColorsArray("growth-chart3");
...
if (BarchartGrowthColors) {
  ...
  var chart2 = new ApexCharts(document.querySelector("#growth-chart3"), options2);
  chart2.render();
} //
