...
(function ($) {
    ...
    //     (body.hasAttribute("data-sidebar-size") && body.getAttribute("data-sidebar-size") == "lg") ? updateRadio('sidebar-size-small') : (body.hasAttribute("data-sidebar-size") && body.getAttribute("data-sidebar-size") == "md") ? updateRadio('sidebar-size-compact') : updateRadio('sidebar-size-default');
    ...
    function layoutSetting(id) {
        var body = document.getElementsByTagName("body")[0];
        const savedTheme = localStorage.getItem('layout-mode');
        const savedLayout = localStorage.getItem('layout');
        if (savedTheme) {
            document.body.setAttribute('data-layout-mode', savedTheme);
            updateRadio(savedTheme === 'dark' ? 'layout-mode-dark' : 'layout-mode-light');
        } else {
            document.body.setAttribute('data-layout-mode', 'light');
        ...
        if (savedLayout) {
            ...
            updateRadio(savedLayout === 'horizontal' ? 'layout-horizontal' : 'layout-vertical');
        } else {
        ...
        function setLayoutMode(mode) {
            ...
            updateRadio(mode === 'dark' ? 'layout-mode-dark' : 'layout-mode-light');
        }
        ...
        $("input[name='layout']").on('change', function () {
            ...
            window.location.href = newLayout === "vertical" ? "index.html" : "layouts-horizontal.html";
        });
        ...
        (body.hasAttribute("data-layout-size") && body.getAttribute("data-layout-size") === "boxed") ?
            updateRadio('layout-width-boxed') : updateRadio('layout-width-fluid');
        ...
        updateRadio(dir === "rtl" ? 'layout-direction-rtl' : 'layout-direction-ltr');
    }
