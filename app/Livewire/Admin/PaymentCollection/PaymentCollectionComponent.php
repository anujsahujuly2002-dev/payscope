...
class PaymentCollectionComponent extends Component
{
    ...
    public function openPrintSlipModal($id,$user_id)
    {
        ...
        // $this->transaction_history = TransactionHistory::where('user_id', $user_id)->first();
        // $this->status = $this->qr_payment_collection
        //     ? Status::where('id', $this->qr_payment_collection->status_id)->first()
        //     : null;

        // $this->paymentModes = PaymentMode::where('id', $id)->first();


        $this->reset('showPaymentModal');
        $this->showPaymentModal = false;
        $this->transationSlip = true;
