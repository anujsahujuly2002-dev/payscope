        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    @canany(['create', 'list'])
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                @if (['create', 'list'])
                                    @canany(['create', 'list'])
                                        <li><a href="{{route('admin.recharge.and.bill.paymentsmobile.recharge')}}">Resources </a></li>
                                    @endcanany
                                @endif --}}
                    ...
                    @canany(['payout-request', 'payout-new-request'])
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                @if (['payout-request', 'payout-new-request'])
                                    @canany(['payout-request', 'payout-new-request'])
                                        <li><a href="{{ route('admin.payout.payout.request') }}">Bulk Payout Request </a></li>
                                    @endcanany
                                @endif
                ...
                {{-- @if (checkRecordHasPermission([
                    ...
                    @canany(['bank-create', 'bank-list', 'bank-edit', 'bank-delete', 'operator-list', 'operator-create',
                        'operator-edit', 'operator-delete', 'benificiary-list', 'benificiary-create'])
                        <li>
                            <a href="javascript: void(0);" class="has-arrow waves-effect">
                                <i class="uil-cog"></i>
                ...
                @if (checkRecordHasPermission([
                        ...
                        'callback-token-delete','api-create', 'api-list', 'api-change-status', 'api-edit'
                    ]))
                    @canany(['login-session', 'api-logs', 'callback-token', 'callback-token-create',
                        'callback-token-delete','api-create', 'api-list', 'api-change-status', 'api-edit'])
                        <li>
                            <a href="javascript:void(0)" class="has-arrow waves-effect">
