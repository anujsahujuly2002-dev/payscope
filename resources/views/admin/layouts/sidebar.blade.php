...
<div class="vertical-menu">
    ...
    <div class="navbar-brand-box">
        <a href="{{ route('admin.dashboard') }}" class="logo logo-dark">
            <span class="logo-sm">
                <img src="{{ asset('/assets/images/2.png') }}" alt="" height="22">
            </span>
            <span class="logo-lg">
        ...
        <a href="{{ route('admin.dashboard') }}" class="logo logo-light">
            ...
            <span class="logo-lg">
                <img src="{{ asset('/assets/images/2.png') }}" alt="" height="20">
            </span>
        </a>
    </div>
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{ route('admin.dashboard') }}">
                        ...
                        <span style="">@lang('translation.Dashboard')</span>
                    </a>
                </li>
                    ...
                    @canany(['create', 'list'])
                        <li>
                            <a href="javascript: void(0);" class="has-arrow waves-effect">
                                ...
                                <span style="">Recharge & Bill Payment</span>
                            </a>
                            <ul class="sub-menu" aria-expanded="false">
                                @if (checkRecordHasPermission(['create', 'list']))
                                    @canany(['create', 'list'])
                                        <li><a href="{{route('admin.recharge.and.bill.paymentsmobile.recharge')}}" style="">Recharge </a></li>
                                    @endcanany
                                @endif
                                <li><a href="javascript:void()" style="">Electricity</a></li>
                            </ul>
                        </li>
                    @endcanany
                @endif --}}
                    ...
                    @canany(['scheme-manager-list', 'scheme-manager-create', 'scheme-manager-edit'])
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                @if (checkRecordHasPermission(['scheme-manager-list', 'scheme-manager-create', 'scheme-manager-edit']))
                                    @canany(['scheme-manager-list', 'scheme-manager-create', 'scheme-manager-edit'])
                                        <li><a href="{{ route('admin.resource.scheme.manager') }}" style="">Scheme Manager</a></li>
                                    @endcanany
                                @endif
                                <li><a href="javascript:void()" style="">Company Manager</a></li>
                                <li><a href="javascript:void()" style="">Company Profile</a></li>
                            </ul>
                        </li>
                    @endcanany
                @endif
                @if (checkRecordHasPermission([
                    ...
                    @canany(['role-list', 'role-delete', 'role-create', 'role-edit', 'permission-list',
                        ...
                        <li>
                            <a href="javascript: void(0);" class="has-arrow waves-effect">
                                <i class="uil-cog"></i>
                                <span style="">Role & Permission</span>
                            </a>
                            <ul class="sub-menu" aria-expanded="false">
                                @if (checkRecordHasPermission(['role-list', 'role-delete', 'role-create', 'role-edit']))
                                    @canany(['role-list', 'role-delete', 'role-create', 'role-edit'])
                                        <li><a style="" href="{{ route('admin.role.list') }}">Role</a></li>
                                    @endcan
                                @endif
                                @if (checkRecordHasPermission(['permission-list', 'permssion-create', 'permission-edit', 'permission-delete']))
                                    @canany(['permission-list', 'permssion-create', 'permission-edit', 'permission-delete'])
                                        <li><a style="" href="{{ route('admin.permission.list') }}">Permission</a></li>
                                    @endcan
                                @endif
                            </ul>
                        </li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                @if (checkRecordHasPermission(['retailer-list', 'retailer-create', 'retailer-edit', 'retailer-delete']))
                                    @canany(['retailer-list', 'retailer-create', 'retailer-edit', 'retailer-delete'])
                                        <li><a style="" href="{{route('admin.retailer.list')}}">Retailer</a></li>
                                    @endcanany
                                @endif
                                @if (checkRecordHasPermission(['api-partner-create', 'api-partner-list', 'api-partner-edit', 'api-partner-delete']))
                                    @canany(['api-partner-create', 'api-partner-list', 'api-partner-edit',
                                        'api-partner-delete'])
                                        <li><a style="" href="{{ route('admin.api.partner.list') }}">Api Partner</a></li>
                                    @endcanany
                                @endif
                ...
                @if (checkRecordHasPermission([
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            ...
                            <span style="">Fund Manager</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            @if (checkRecordHasPermission(['fund-manager-manual-request', 'fund-new-request', 'approved-fund-request']))
                                @canany(['fund-manager-manual-request', 'fund-new-request', 'approved-fund-request'])
                                    <li><a style="" href="{{ route('admin.fund.manual.request') }}">Manual Request</a></li>
                                @endcanany
                            @endif
                            @if (checkRecordHasPermission(['virtual-list']))
                                @canany(['virtual-list'])
                                    <li><a style="" href="{{ route('admin.fund.virtual.request') }}">Virtual Request</a></li>
                                @endcanany
                            @endif
                            @if (['qr-request-add-fund', 'qr-request-add-list'])
                                @canany(['qr-request-add-fund', 'qr-request-list'])
                                    <li><a style="" href="{{ route('admin.fund.qr.request') }}">QR Request</a></li>
                                @endcanany
                            @endif

                            <li><a href="javascript:void()" style="">Transfer Return</a></li>
                    ...
                    @canany(['payout-request', 'payout-new-request', 'qr-request-add-fund', 'qr-request-add-list'])
                        <li>
                            <a href="javascript: void(0);" class="has-arrow waves-effect">
                                ...
                                <span style="">Payout Manager</span>
                            </a>
                            <ul class="sub-menu" aria-expanded="false">
                                @if (['payout-request', 'payout-new-request'])
                                    @canany(['payout-request', 'payout-new-request'])
                                        <li><a style="" href="{{ route('admin.payout.payout.request') }}">Payout Request </a></li>
                                    @endcanany
                                @endif

                                <li><a href="javascript:void()" style="">Bulk Payout</a></li>
                                <li><a href="javascript:void()" style="">Schedule Payout</a></li>
                                <li><a href="javascript:void()" style="">Payout Links</a></li>
                            </ul>
                        </li>
                    @endcanany
                @endif
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span style="">Wallet Statement</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="javascript:void()" style="">Main Wallet</a></li>
                        <li><a href="javascript:void()" style="">Api Wallet</a></li>
                    </ul>
                </li>
                {{-- <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            @if (checkRecordHasPermission([
                                    ...
                                    'callback-token-delete','bank-create', 'bank-list', 'bank-edit', 'bank-delete', 'operator-list', 'operator-create', 'operator-edit', 'operator-delete', 'benificiary-list', 'benificiary-create',
                                ]))
                                @canany(['api-create', 'api-list', 'api-change-status', 'api-edit', 'login-session',
                                    'api-logs', 'callback-token', 'callback-token-create', 'callback-token-delete','bank-create', 'bank-list', 'bank-edit', 'bank-delete', 'operator-list', 'operator-create', 'operator-edit', 'operator-delete', 'benificiary-list', 'benificiary-create'])
                                    <li><a style="" href="{{ route('admin.admin-setting.api.list') }}">Api Manager </a></li>
                                @endcanany
                            @endif
                            <li><a href="javascript:void()">Operator Manager</a></li>
                            @if (checkRecordHasPermission(['api-logs']))
                                @can('api-logs')
                                    <li><a style="" href="{{ route('admin.log.manager.api.logs') }}">Api Logs</a></li>
                                @endcan
                            @endif
                            @if (checkRecordHasPermission(['login-session']))
                                @can('login-session')
                                    <li><a style="" href="{{ route('admin.log.manager.login.session') }}">Login Session </a></li>
                                @endcan
                            @endif
                            @if (checkRecordHasPermission(['callback-token', 'callback-token-create', 'callback-token-delete']))
                                @canany(['callback-token', 'callback-token-create', 'callback-token-delete'])
                                    <li><a style="" href="{{ route('admin.api.setting') }}">Callback & Token</a></li>
                                @endcanany
                            @endif
                            @if (checkRecordHasPermission(['bank-create', 'bank-list', 'bank-edit', 'bank-delete']))
                            @canany(['bank-create', 'bank-list', 'bank-edit', 'bank-delete'])
            ...
            @endif
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="uil-cog"></i>
                        <span style="">Portal Setting</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a style="" href="javascript:void()">Login OTP</a></li>
                        <li><a style="" href="javascript:void()">Wallect Lock</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a style="" href="{{ route('admin.domestic.money.transfer.recipient.list') }}">Recipient List</a></li>
                        <li><a style="" href="javascript:void()">Money Transfer</a></li>
                    </ul>
                </li>
