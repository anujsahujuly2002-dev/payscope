                            ...
                            <tbody>
                                @foreach ($retailers as $key => $retailer)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="checkbox" id="switch{{ $retailer->id }}" switch="bool"
                                                @if ($retailer->status == 1) checked @endif
                                                wire:change='statusUpdate({{ $retailer->id }},{{ $retailer->status }})' />
                                            <label for="switch{{ $retailer->id }}" data-on-label="Active"
                                            ...
                                            <li class="list-inline-item dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href="javascript:void(0)"
                                                        wire:click="assignPermissionUserBassed({{ $retailer->id }})">Permission</a>
                                                    {{-- @if (checkRecordHasPermission(['view-profile'])) --}}
                                                    {{-- @can('view-profile') --}}
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.view.profile', base64_encode($retailer->id)) }}">Profile</a>
                                                    {{-- @endcan --}}
                                                    {{-- @endif --}}
                                                    <a class="dropdown-item" href="javascript:void(0)"
                                                        wire:click="changeScheme({{ $retailer->id }},'dmt')">Scheme</a>
                                                </div>
                                            </li>
                                        </td>
                                    </tr>
