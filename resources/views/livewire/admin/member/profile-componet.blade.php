                        ...
                        <div class="table-responsive mt-4">
                            ...
                            <div class="mt-4">
                                ...
                                <h5 class="font-size-16">
                                    {{ $user->getRoleNames()->first() == 'api-partner' ? $user?->apiPartner?->address : $user?->retailer?->address }},{{ $user->getRoleNames()->first() == 'api-partner' ? ucwords($user?->apiPartner?->state?->name) : ucwords($user?->retailer?->state?->name) }}
                                </h5>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-xl-8">
            <div class="card mb-0">
                ...
                <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link @if ($tab != 'password manager') active @endif" data-bs-toggle="tab"
                            href="#about" role="tab">
                ...
                <div class="tab-content p-4">
                    <div class="tab-pane @if ($tab != 'password manager') active show @endif" id="about"
                        role="tabpanel">
                        <div class="card">
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-md-6 mb-0">
                                            ...
                                            <input type="text" id="name"
                                                ...
                                                placeholder="Enter Mobile" wire:model.defer='state.mobile_no'>
                                            @error('mobile_no')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-6 mb-0">
                                            ...
                                            <select id="state_name"
                                                ...
                                                placeholder="Enter State" wire:model.defer='state.state_name'>
                                        ...
                                        <div class="col-md-12">
                                            <button type="submit"
                                                class="btn btn-primary waves-effect waves-light me-1">Update</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="tab-pane @if ($tab == 'password manager') active show @endif" id="tasks"
                        role="tabpanel">
                        <div class="card">
                            <div class="card-header">
                            ...
                            <div class="card-body">
                                <form wire:submit.prevent="updateBankInformation" autocomplete="off">
                                    <div class="row g-2">
                                        <div class="col-md-6 mb-0">
                                            <label for="bank_name" class="form-label">Bank Name</label>
                                            <input type="text" id="bank_name"
                                                class="form-control  @error('bank_name') is-invalid @enderror"
                                                placeholder="Enter Bank Name" wire:model.defer='state.bank_name'>
                                            @error('bank_name')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-6 mb-0">
                                            ...
                                            <input type="text" id="ifsc"
                                                ...
                                                placeholder="Enter Ifsc Code" wire:model.lazy='state.ifsc_code' />
                                            @error('ifsc_code')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-6 mb-0">
                                            ...
                                            <input type="text" id="branch_name"
                                                ...
                                                placeholder="Enter Branch" wire:model.lazy='state.branch_name' />
                                            @error('branch_name')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                    ...
                    <div class="tab-pane @if ($tab == 'password manager') active show @endif" id="messages"
                        role="tabpanel">
                        <div class="card">
                            <div class="card-header">
                                    ...
                                    <div class="row g-2">
                                        <div class="col-md-6 mb-0">
                                            ...
                                            <input type="text" id="old_password"
                                                ...
                                                wire:model.defer='password.old_password'>
                                            @error('old_password')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-6 mb-0">
                                            ...
                                            <input type="text" id="new_password"
                                                ...
                                                wire:model.defer='password.new_password'>
                                            @error('new_password')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-6 mb-0">
                                            ...
                                            <input type="text" id="confirm_password"
                                                ...
                                                wire:model.defer='password.confirm_password'>
