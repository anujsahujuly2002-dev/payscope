                                    ...
                                    <td>
                                        <li class="list-inline-item dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                @endcanany
                                                @endif
                                                <a class="dropdown-item" href="javascript:void(0)" wire:click="wallet({{$apipartner->id}})">Wallet</a>

                                                <a class="dropdown-item" href="javascript:void(0)" wire:click="lockedWallet({{$apipartner->id}})"> Locked Wallet</a>
                                            </div>
                                        </li>
                                    </td>
                                </tr>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-0 mt-2">
                                ...
                                <input type="text" id="locked_wallet_amount"
                                    ...
                                    placeholder="Enter your amount"
                                    wire:model.defer='lockedWalletAmount' />
