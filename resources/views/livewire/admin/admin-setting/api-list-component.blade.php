                            ...
                            <tbody>
                                @foreach ($apiLists as $key => $api)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void()" data-bs-html="true" data-bs-toggle="popover"
                                                data-bs-trigger="hover" data-bs-placement="top"
                                                data-bs-title="{{ $api->name }}"
                                                data-bs-content="Url :-{{ $api->url }} <br>Username:- {{ $api->username }} <br> Password :- {{ $api->password }} <br> Optional:-{{ $api->optional }}">Api
                                                Credentials </a>
                                        </td>
                                        <td>
                                            <input type="checkbox" id="switch{{ $api->id }}" switch="bool"
                                                @if ($api->status == 1) checked @endif
                                                wire:change='statusUpdate({{ $api->id }},{{ $api->status }})' />
                                            <label for="switch{{ $api->id }}" data-on-label="Active"
                                    ...
                                    <ul class="pagination mb-sm-0">
                                        ...
                                        @foreach (range(1, $apiLists->lastPage()) as $i)
                                            @if ($i >= $apiLists->currentPage() - 2 && $i <= $apiLists->currentPage())
                                                <li class="page-item @if ($apiLists->currentPage() == $i) active @endif"
                                        ...
                                        @if ($apiLists->currentPage() < $apiLists->lastPage() - 2)
                                            <li class="page-item" wire:click="gotoPage({{ $apiLists->lastPage() }})">
                                                <a href="javascript:void(0)"
                                                    class="page-link">{{ $apiLists->lastPage() }}</a>
                                            </li>
                                        @endif
                        ...
                        <div class="row g-2">
                            <div class="col-md-6 mb-0">
                                ...
                                <input type="text" id="api_name"
                                    class="form-control  @error('api_name') is-invalid @enderror"
                                    placeholder="Enter  Api Name" wire:model='state.api_name' />
                                @error('api_name')
                            ...
                            <div class="col-md-6 mb-0">
                                ...
                                <input type="text" id="api_code"
                                    class="form-control  @error('api_code') is-invalid @enderror"
                                    placeholder="Enter Api Code" wire:model='state.api_code' />
                                @error('api_code')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 mb-0">
                                ...
                                <input type="text" id="api_url"
                                    ...
                                    placeholder="Enter Api Url" wire:model='state.api_url' />
                                @error('api_url')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 mb-0">
                                ...
                                <input type="text" id="username"
                                    ...
                                    placeholder="Enter Username" wire:model='state.username' />
                                @error('username')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 mb-0">
                                ...
                                <input type="text" id="password"
                                    ...
                                    placeholder="Enter Password" wire:model='state.password' />
                                @error('password')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 mb-0">
                                ...
                                <input type="text" id="optional1"
                                    class="form-control  @error('optional1') is-invalid @enderror"
                                    placeholder="Enter Optional1" wire:model='state.optional1' />
                                @error('optional1')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
